                    ...
                    <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="default-styled-tab"
                        ...
                        <li class="me-2" role="presentation">
                            <button class="text-base inline-block p-4 border-b-2 rounded-t-lg" id="profile-styled-tab"
                                data-tabs-target="#styled-profile-page" type="button" role="tab" aria-controls="profile"
                        ...
                        <li class="me-2" role="presentation">
                            <button
                                ...
                                id="dashboard-styled-tab" data-tabs-target="#styled-dashboard-profile-page" type="button"
                                role="tab" aria-controls="dashboard" aria-selected="false">Job</button>
                        </li>
                    </ul>
                </div>
                <!-- Modal body -->
