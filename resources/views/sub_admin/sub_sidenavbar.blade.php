...
<div class="wrapper">
  ...
  <a id="dashboard-link" href="{{route('sub.admin.dashboard')}}" class="nav-link "id="dashboard-link">
    ...
    <p>
      Dashboard
          ...
          <li class="nav-item">
            <a href="{{ route('subadmin.team')}}" class="nav-link">
...
<li class="nav-item">
    <a href="{{ route('subadmin.communication')}}" class="nav-link">
