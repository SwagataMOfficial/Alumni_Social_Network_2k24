    ...
    <div class="hidden lg:flex items-center gap-6 xl:gap-8">
        ...
        <div id="dropdownOptions" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow">
            ...
            <ul class="py-2 text-sm text-gray-700" aria-labelledby="dropdownInformationButton">
                ...
                <li>
                    <button data-modal-target="support-modal" data-modal-toggle="support-modal" id="help-and-support"
                        class="block px-4 py-2 hover:bg-gray-100 w-full text-left" type="button">Help &
                        Support</button>
                </li>
            </ul>
            <div class="py-2">
...
<div id="support-modal" tabindex="-1"
        ...
        <div class="relative bg-white rounded-lg shadow">
            ...
            <div class="p-4 md:p-5 text-center">
                ...
                <form id="supportForm">
                    ...
                    <button data-modal-hide="support-modal" type="button"
                        class="py-2.5 px-5 ms-3 text-sm font-medium text-white  bg-red-500 rounded-lg border hover:bg-red-600 focus:z-10 focus:ring-2 focus:outline-none focus:ring-red-800">Close</button>
                </form>
            </div>
        </div>
    </div>
