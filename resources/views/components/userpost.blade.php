<div class="relative bg-white shadow-lg rounded-lg overflow-hidden max-w-lg mx-auto mb-4">
    ...
    <div class="flex items-center space-x-4 p-4">
        ...
        @php
            use Carbon\Carbon;
            // Given date
            // $givenDate = Carbon::createFromDate(2024, 4, 20); // Example: May 1, 2024
    ...
    <div class="p-2">
            ...
            <div id="indicators-carousel" class="relative w-full mt-4" data-carousel="static">
                ...
                <div class="relative h-56 overflow-hidden rounded-lg md:h-80">
                    ...
                    <div class="hidden duration-700 ease-in-out" data-carousel-item="active">
                        <img src="storage\2115230100\uploads\1713812029_0.jpg"
                            class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
                            alt="...">
                    </div>
                    <!-- Item 2 -->
                    <div class="hidden duration-700 ease-in-out" data-carousel-item>
                        <img src="storage\2115230100\uploads\1713814700_0.jpg"
                            class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
                            alt="...">
                    </div>
                    <!-- Item 3 -->
                    <div class="hidden duration-700 ease-in-out" data-carousel-item>
                        <img src="storage\2115230100\uploads\1713814718_0.jpg"
                            class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
                            alt="...">
                    </div>
                    <!-- Item 4 -->
                    <div class="hidden duration-700 ease-in-out" data-carousel-item>
                        <img src="storage\2115230100\uploads\1713814737_0.png"
                            class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
                            alt="...">
                    </div>
                    <!-- Item 5 -->
                    <div class="hidden duration-700 ease-in-out" data-carousel-item>
                        <img src="storage\2115230100\verification_document\verify_doc.jpg"
                            class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
                            alt="...">
                    </div>
                </div>
        ...
        @endif
        <img src="{{ asset('/storage/' . $posts['attachment']) }}" alt="Posted Picture" class="mt-4 rounded-lg">
    </div>

    <!-- Options -->
    <div class="p-4 flex justify-between items-center">
        <button type="button" class="like_btns text-gray-500 hover:text-blue-500 focus:outline-none flex items-center"
            id="{{ $posts['post_id'] }}">
