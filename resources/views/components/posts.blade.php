<div class="container mx-auto mt-4 lg:w-full">
    ...
    <div class="flex items-center justify-center">
        <div
            ...
            <div class="ml-4 flex items-center space-x-14 mr-4">
                ...
                <button data-modal-target="text_job_modal_profile_page" data-modal-toggle="text_job_modal_profile_page"
                    type="button" id="text_or_job_post_btn_profile_page">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="w-6 h-6 cursor-pointer hover:text-stone-600">
    ...
    @if (count($posts) != 0)
        @foreach ($posts as $index => $post)
            <x-profilepostview :details="$post['get_user']" :likeduser="$post['get_liked_user']" :posts="$post" :key="$index" />
        @endforeach
    @else
